...
qInitConfig(13, {
  ...
  feedback: {
    retry: { title: 'זו אינה התשובה,', body: ['הפעילו שוב את ההתנסות, התבוננו בתהליך ונסו שוב.'] },
...
qInitConfig(16, {
  ...
  feedback: {
    retry: { title: 'זו אינה התשובה, נסו שוב.', body: [] },
    correct: { title: 'צדקת!', body: ['ההתנסות מראה שהנורה נכבית כאשר היא מתחממת מדי, ונדלקת מחדש לאחר שהתקררה. מכאן אפשר להסיק שהבהוב האורות נגרם ממנגנון הגנה מפני התחממות יתר.'] },
    wrong2: { title: 'זו טעות, כל הכבוד על הניסיון.', body: ['ההתנסות מראה שהנורה נכבית כאשר היא מתחממת מדי, ונדלקת מחדש לאחר שהתקררה. מכאן אפשר להסיק שהבהוב האורות נגרם ממנגנון הגנה מפני התחממות יתר.'] }
  }
});
qInitConfig(19, {
