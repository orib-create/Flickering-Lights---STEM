...
function s12ToggleAudio() {
  ...
  if (audio.paused) {
    audio.playbackRate = 1.15; // slightly faster pace, per feedback
...
const VIDEO_CAPTIONS = {
  ...
  11: [
    ...
    [8.78, 10.9, 'אפשר לבדוק את זה באמצעות הדמיה.'],
  ...
  17: [
    ...
    [15.61, 17.49, 'בואו נראה את זה בהדמיה.']
  ],
  25: [
...
qInitConfig(13, {
  ...
  feedback: {
    retry: { title: 'זו אינה התשובה,', body: ['הפעילו שוב את ההדמיה, התבוננו בתהליך ונסו שוב.'] },
...
qInitConfig(16, {
  ...
  feedback: {
    retry: { title: 'זו אינה התשובה, נסו שוב.', body: [] },
    correct: { title: 'צדקת!', body: ['ההדמיה מראה שהנורה נכבית כאשר היא מתחממת מדי, ונדלקת מחדש לאחר שהתקררה. מכאן אפשר להסיק שהבהוב האורות נגרם ממנגנון הגנה מפני התחממות יתר.'] },
    wrong2: { title: 'זו טעות, כל הכבוד על הניסיון.', body: ['ההדמיה מראה שהנורה נכבית כאשר היא מתחממת מדי, ונדלקת מחדש לאחר שהתקררה. מכאן אפשר להסיק שהבהוב האורות נגרם ממנגנון הגנה מפני התחממות יתר.'] }
  }
});
qInitConfig(19, {
  kind: 'multi', key: 'q4a', weight: 5, correctSet: ['2', '4'],
  feedback: {
    retry: { title: 'זו אינה התשובה, נסו שוב.', body: ['הפעילו שוב את ההדמיה, התבוננו בתהליך ונסו שוב.'] },
    retryPartial: { title: 'זו תשובה נכונה חלקית, מה הוא הסימן הנוסף?', body: ['הפעילו שוב את ההדמיה, התבוננו בתהליך ונסו שוב.'] },
    correct: { title: 'צדקת!', body: ['בהדמיה אפשר לזהות חיבור רופף לפי שני סימנים: הזרם החשמלי אינו רציף, והנורה מהבהבת או נחלשת לסירוגין.'] },
    partial: { title: 'זו תשובה חלקית', body: ['בהדמיה אפשר לזהות חיבור רופף לפי שני סימנים: הזרם החשמלי אינו רציף, והנורה מהבהבת או נחלשת לסירוגין.'] },
    wrong2: { title: 'זו טעות, כל הכבוד על הניסיון.', body: ['בהדמיה אפשר לזהות חיבור רופף לפי שני סימנים: הזרם החשמלי אינו רציף, והנורה מהבהבת או נחלשת לסירוגין.'] }
  }
});
qInitConfig(20, {
